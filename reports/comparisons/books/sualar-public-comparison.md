...
- Ortak bölüm sayısı: **18**
- Genel sıra-duyarlı benzerlik: **0.9954**
- Genel içerik örtüşmesi: **0.9945**
- Toplam farklı token: **1029**
...
- Sıra benzerliği: **0.3427** · İçerik örtüşmesi: **0.2176** · Fark tokenı: **681**

1. `delete`
   - Upstream: Onuncu Şuâ, Fihriste Risâlesi’nin ikinci kısmıdır. Şuâlar eserinde Onuncu Şuâ boştur Kısaca şöyle bir açıklama yapılmıştır : Onuncu Şuâ; Bu Şuâ, On Beşinci Lem’a’dan itibaren buraya kadar olan
   - Public: (boş)
2. `replace`
   - Upstream: BAB İKİNCİ BAB
   - Public: BAB: İKİNCİ BAB:
3. `replace`
   - Upstream: 1. BİRİNCİ MESELE 2. İKİNCİ MESELE 3.
   - Public: BİRİNCİ MESELE İKİNCİ MESELE

### Eddâî

- Sıra benzerliği: **0.9259** · İçerik örtüşmesi: **0.8929** · Fark tokenı: **13**
...
- Sıra benzerliği: **0.9968** · İçerik örtüşmesi: **0.9968** · Fark tokenı: **54**
...
- Sıra benzerliği: **0.9971** · İçerik örtüşmesi: **0.9966** · Fark tokenı: **7**
