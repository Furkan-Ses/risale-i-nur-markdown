...
- Public bölüm sayısı: **20**
- Ortak bölüm sayısı: **20**
- Genel sıra-duyarlı benzerlik: **0.9980**
- Genel içerik örtüşmesi: **0.9972**
- Toplam farklı token: **290**
...
- Sıra benzerliği: **0.9954** · İçerik örtüşmesi: **0.9948** · Fark tokenı: **26**
...
- Sıra benzerliği: **0.9960** · İçerik örtüşmesi: **0.9936** · Fark tokenı: **28**
...
- Sıra benzerliği: **0.9962** · İçerik örtüşmesi: **0.9940** · Fark tokenı: **33**
...
- Sıra benzerliği: **0.9966** · İçerik örtüşmesi: **0.9966** · Fark tokenı: **25**

1. `replace`
   - Upstream: ( اِسْتِشْفَاءْ )
   - Public: (اِسْتِشْفَاءْ)
2. `replace`
   - Upstream: ( اِسْتِشْفَاعْ )
   - Public: (اِسْتِشْفَاعْ)
3. `insert`
   - Upstream: (boş)
   - Public: (Hâşiye [1] )
