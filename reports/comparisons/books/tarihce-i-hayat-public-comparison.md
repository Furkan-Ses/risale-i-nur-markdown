...
- Public bölüm sayısı: **14**
- Ortak bölüm sayısı: **10**
- Genel sıra-duyarlı benzerlik: **0.9977**
- Genel içerik örtüşmesi: **0.9971**
- Toplam farklı token: **571**
- Yalnız upstream bölümleri: **2**
- Yalnız public bölümleri: **4**
- Durum: **very-high**
...
- Eskişehir Hayatı (https://risaleinur.hizmetvakfi.org/eskisehir-hayati/)
- Giriş (https://risaleinur.hizmetvakfi.org/giris/)
- Hariç Memleketler (https://risaleinur.hizmetvakfi.org/haric-memleketler/)
- İçindekiler (https://risaleinur.hizmetvakfi.org/icindekiler/)
...
- Sıra benzerliği: **0.9943** · İçerik örtüşmesi: **0.9929** · Fark tokenı: **264**
...
- Sıra benzerliği: **0.9976** · İçerik örtüşmesi: **0.9974** · Fark tokenı: **64**
...
- Sıra benzerliği: **0.9977** · İçerik örtüşmesi: **0.9977** · Fark tokenı: **56**
...
2. `replace`
   - Upstream: ![Üstadın
   - Public: (Hâşiye [2] ) (Üstadın talebelerine gönderdiği ve
3. `replace`
   - Upstream: mektup](mektup1.jpg) Üstadın talebelerine gönderdiği ve kendi el yazısıyla yazdığı bir mektup
   - Public: mektup)

### Isparta Hayatı

- Sıra benzerliği: **0.9984** · İçerik örtüşmesi: **0.9977** · Fark tokenı: **42**
