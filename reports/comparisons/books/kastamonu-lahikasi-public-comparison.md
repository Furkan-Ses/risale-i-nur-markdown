...
- Public bölüm sayısı: **13**
- Ortak bölüm sayısı: **12**
- Genel sıra-duyarlı benzerlik: **0.9982**
- Genel içerik örtüşmesi: **0.9976**
- Toplam farklı token: **171**
...
- Kastamonu Lâhikası s.150-166 (Lemaat’tan) (https://risaleinur.hizmetvakfi.org/kastamonu-lahikasi-s-150-166-lemaattan/)
...
- Sıra benzerliği: **0.9958** · İçerik örtüşmesi: **0.9957** · Fark tokenı: **33**

1. `replace`
   - Upstream: ‌ اَلْحَمْدُ
   - Public: ‌اَلْحَمْدُ
2. `replace`
   - Upstream: الْكَائِنَاتِ ‌
   - Public: الْكَائِنَاتِ‌
3. `insert`
   - Upstream: (boş)
   - Public: (Hâşiye [1] )
...
- Sıra benzerliği: **0.9969** · İçerik örtüşmesi: **0.9956** · Fark tokenı: **23**
...
- Sıra benzerliği: **0.9975** · İçerik örtüşmesi: **0.9965** · Fark tokenı: **23**
...
- Sıra benzerliği: **0.9977** · İçerik örtüşmesi: **0.9973** · Fark tokenı: **18**
